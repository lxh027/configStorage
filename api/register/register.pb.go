...
type RegisterRaftArgs struct {
	...
	RaftID     int64  `protobuf:"varint,2,opt,name=RaftID,proto3" json:"RaftID,omitempty"`
...
func (x *RegisterRaftArgs) GetRaftID() int64 {
	if x != nil {
		return x.RaftID
	}
	return 0
...
func (x *GetRaftRegistrationsArgs) GetRaftID() int64 {
	if x != nil {
		return x.RaftID
	}
	return 0
...
var file_api_register_register_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x52, 0x61, 0x66, 0x74, 0x49, 0x44, 0x12, 0x12, 0x0a, 0x04,
	...
	0x16, 0x0a, 0x06, 0x52, 0x61, 0x66, 0x74, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52,
